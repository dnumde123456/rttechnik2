...
const teamMembers = [
	...
	},
	{
		...
		titlePl: "",
		bio: "",
		image: "/teamMembers/Maksim Tatarenka.png",
		order: 10
	}
];
	...
	return (
		<div className="min-h-screen pt-20">
			<div className="container mx-auto px-4 py-16">
				...
				{leadership.length > 0 && (
					<div className="mb-24">
						<h2 className="relative pb-4 text-3xl font-bold text-center mb-12 after:content-[''] after:absolute after:left-1/2 after:-translate-x-1/2 after:bottom-0 after:h-1 after:w-24 after:bg-amber-400 after:rounded-full">Kierownictwo</h2>
								...
								>
									<div className="md:grid md:grid-cols-12">
										...
										<div className="md:col-span-8 p-10 md:p-16 flex flex-col justify-center">
											<h3 className="text-3xl lg:text-4xl font-bold mb-2 text-gray-900 dark:text-white">{member.namePl}</h3>
											<p className="text-amber-600 dark:text-amber-400 text-xl lg:text-2xl font-semibold mb-6 tracking-wide">{member.titlePl}</p>
											<p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
												{member.bio || "Z ponad dwudziestoletnim doświadczeniem w branży, Bernhard Zach prowadzi RTTechnik z wizją innowacji i doskonałości. Jego przywództwo jest kluczem do naszego sukcesu w dostarczaniu najnowocześniejszych rozwiązań dla pomieszczeń czystych."}
											</p>
										</div>
									</div>
								</Card>
